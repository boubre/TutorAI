...
{
    /// <summary>
    /// A window that allows the user to enter solutions and receive hints.
    /// </summary>
    public class EnterSolutionWindow : ChildWindow
    {
        ...
        public EnterSolutionWindow()
        {
            ...
            enterSolutionWindow.Closed += new EventHandler(EnterSolutionWindow_Closed);
            LayoutDesign();
        }
        ...
        /// <summary>
        /// This executes the closing event when the Enter Solution window is closed.
        /// The method refreshes the groups list and rebinds the visible assumptions.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void EnterSolutionWindow_Closed(object sender, EventArgs e)
        {
