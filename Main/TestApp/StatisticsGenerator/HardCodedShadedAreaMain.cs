...
namespace StatisticsGenerator
{
    public class HardCodedShadedAreaMain
    {
        ...
        private List<GeometryTutorLib.Area_Based_Analyses.AtomicRegion> regions;
        ...
        private GeometryTutorLib.Area_Based_Analyses.AreaHypergraph areaGraph;
        ...
        public HardCodedShadedAreaMain(List<GeometryTutorLib.ConcreteAST.GroundedClause> fs,
                                       List<GeometryTutorLib.Area_Based_Analyses.AtomicRegion> rs,
        ...
        public ShadedAreaFigureStatisticsAggregator AnalyzeFigure()
        {
            ...
            //KeyValuePair<List<GeometryTutorLib.ProblemAnalyzer.Problem<GeometryTutorLib.Hypergraph.EdgeAnnotation>>, List<GeometryTutorLib.ProblemAnalyzer.Problem<GeometryTutorLib.Hypergraph.EdgeAnnotation>>> problems = GenerateTemplateProblems();
        ...
        private void ConstructHypergraph()
        {
            ...
            graph = instantiator.Instantiate(figure, new List<GeometryTutorLib.ConcreteAST.GroundedClause>());
        }
