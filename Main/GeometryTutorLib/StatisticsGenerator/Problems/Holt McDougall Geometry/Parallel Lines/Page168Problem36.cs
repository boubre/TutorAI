...
namespace GeometryTutorLib.StatisticsGenerator
{
    ...
    public class Page168Problem36 : ParallelLinesProblem
    {
        public Page168Problem36(bool onoff) : base(onoff)
        {
            ...
            given.Add(new GeometricCongruentAngles(ClauseConstructor.GetProblemAngle(intrinsic, new Angle(g, e, f)),
                                                   ClauseConstructor.GetProblemAngle(intrinsic, new Angle(a, b, h))));
