...
namespace GeometryTutorLib.StatisticsGenerator
{
    ...
    public class Page166Problem25 : ParallelLinesProblem
    {
        public Page166Problem25(bool onoff) : base(onoff)
        {
            ...
            given.Add(new Supplementary(ClauseConstructor.GetProblemAngle(intrinsic, new Angle(b, e, g)), ClauseConstructor.GetProblemAngle(intrinsic, new Angle(e, f, c))));

            goals.Add(new GeometricParallel(ClauseConstructor.GetProblemSegment(intrinsic, new Segment(a, b)), ClauseConstructor.GetProblemSegment(intrinsic, new Segment(c, d))));
        }
    }
}