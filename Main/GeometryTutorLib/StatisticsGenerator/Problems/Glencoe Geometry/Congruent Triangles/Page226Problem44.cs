...
namespace GeometryTutorLib.StatisticsGenerator
{
    ...
    public class Page226Problem44 : CongruentTrianglesProblem
    {
        public Page226Problem44(bool onoff) : base(onoff)
        {
            ...
            given.Add(new GeometricCongruentAngles(ClauseConstructor.GetProblemAngle(intrinsic, new Angle(x, v, w)), ClauseConstructor.GetProblemAngle(intrinsic, new Angle(x, z, y))));
            given.Add(new GeometricCongruentSegments(ClauseConstructor.GetProblemSegment(intrinsic, new Segment(w, x)), ClauseConstructor.GetProblemSegment(intrinsic, new Segment(x, y))));
