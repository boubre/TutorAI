...
namespace GeometryTutorLib.StatisticsGenerator
{
	...
	public class Page175ClassroomExercise12 : CongruentTrianglesProblem
	{
        public Page175ClassroomExercise12(bool onoff) : base(onoff)
		{
			...
			given.Add(new Midpoint(GetProblemInMiddle(intrinsic, m, new Segment(x, y))));
            given.Add(new Midpoint(GetProblemInMiddle(intrinsic, n, new Segment(z, y))));
            given.Add(new Midpoint(GetProblemInMiddle(intrinsic, t, new Segment(z, x))));
