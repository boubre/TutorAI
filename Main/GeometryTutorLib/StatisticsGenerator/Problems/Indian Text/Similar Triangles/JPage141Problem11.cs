...
namespace GeometryTutorLib.StatisticsGenerator
{
    public class JPage141Problem11 : SimilarTrianglesProblem
    {
        public JPage141Problem11(bool onoff) : base(onoff)
        {
            ...
            given.Add(new GeometricCongruentSegments(ab, ClauseConstructor.GetProblemSegment(intrinsic, new Segment(a, c))));
            given.Add(new RightAngle(ClauseConstructor.GetProblemAngle(intrinsic, new Angle(a, d, c))));
            given.Add(new RightAngle(ClauseConstructor.GetProblemAngle(intrinsic, new Angle(e, f, c))));
