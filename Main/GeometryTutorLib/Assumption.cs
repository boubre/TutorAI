...
namespace GeometryTutorLib
{
    ...
    public class Assumption
    {
        ...
        /// </summary>
        private static Dictionary<JustificationSwitch.DeductionJustType, Assumption> assumptions = null;
        ...
        public static Dictionary<JustificationSwitch.DeductionJustType, Assumption> GetAssumptions()
        {
            if (assumptions == null)
            {
                assumptions = JustificationSwitch.GetAssumptions();
            }
            return assumptions;
        }
