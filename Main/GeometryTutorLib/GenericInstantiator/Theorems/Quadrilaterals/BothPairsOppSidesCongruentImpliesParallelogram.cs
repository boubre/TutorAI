...
namespace GeometryTutorLib.GenericInstantiator
{
    public class BothPairsOppSidesCongruentImpliesParallelogram : Theorem
    {
        ...
        private static Hypergraph.EdgeAnnotation annotation = new Hypergraph.EdgeAnnotation(NAME, JustificationSwitch.OPPOSITE_SIDES_CONGRUENT_IMPLIES_PARALLELOGRAM);
