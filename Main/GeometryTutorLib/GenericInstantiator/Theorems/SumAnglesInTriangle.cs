...
namespace GeometryTutorLib.GenericInstantiator
{
    public class SumAnglesInTriangle : Theorem
    {
        ...
        private static Hypergraph.EdgeAnnotation annotation = new Hypergraph.EdgeAnnotation(NAME, GenericInstantiator.JustificationSwitch.SUM_ANGLES_IN_TRIANGLE_180);
