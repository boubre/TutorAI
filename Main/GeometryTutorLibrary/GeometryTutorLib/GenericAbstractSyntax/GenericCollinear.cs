...
{
    public class GenericCollinear : GenericDefinition
    {
        private GenericPoint gp1 = null;
        private GenericPoint gp2 = null;
        private GenericPoint gp3 = null;

        public GenericCollinear(int id, string name, GenericPoint p1, GenericPoint p2, GenericPoint p3) : base(id, name)
        {
            gp1 = p1;
            gp2 = p2;
            gp3 = p3;
